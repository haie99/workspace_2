/*
 멀티 주석 crrl + shift + /(슬래시)
 멀티 주석 해제 : crtl + shift +\(역슬래시) 
 싱글 라인 주석 : crtl + /슬래시
 싱글 라인 주석 해제 : crtl + \역슬래시
AWT는 플랫폼에 따라 디자인이 다르게 표현되는 문제가 있기에 , AWT를 개선한 API인 Swing을 사용해본다
Swing은 새롭게 배울 필요 없으며, 기존 우리가 사용해오던 AWT컴포넌트에 대부분 J접두어가 붙는다
 */
package day1027.gui;
...
public class SwingTest extends JFrame {
	...
	public SwingTest() {
		...
		//따라서 완전히 프로그램을 종료시키려면, 콘솔 종료 버튼을 누르던가, 아래의 코드를 작성하면됨
